...
function addDataToMap() {
	var geojson = L.geoJson(statesData, {
		onEachFeature: function(feature, layer) {
			...
			{
			 check=1;
			 console.log(feature.properties.casi);
			}
	...
	//		reg=reg.replace("Emilia Romagna","Emilia-Romagna");
	//		reg=reg.replace("Valle d'Aosta","Valle d_Aosta");
	//	console.log(reg);
...
<?php
				...
				echo "popupString += 'Provincia di <b>' + feature.properties.prov_name + '</b> ('+feature.properties.popolazione+' ab.)<br />';";
					...
					?>	if (document.body.clientWidth <= 767) {
						<?php echo "popupString += '<a href=\"filternew.php?regione='+ reg+'&data=nuovi_positivi\">Vai alla serie storica nuovi casi</a></br>';"; ?>
					}else{
						<?php echo "popupString += '<div><iframe src=\"filternew.php?regione='+ reg +'&data=nuovi_positivi\" width=\"280\" scrolling=\"no\" scrolling=\"no\" height=\"320\" frameBorder=\"0\">prova</iframe></div>';";?>
