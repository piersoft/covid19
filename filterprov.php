...
if (htmlspecialchars($_GET["provincia"]) =="L'Aquila") $_GET["provincia"]="L\'Aquila";
 ?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <!--  <script src="assets/scripts4.js"></script>-->
    ...
    var options1 = {
      ...
      title: {
        text: '<?php echo htmlspecialchars($_GET["provincia"]); ?>',
      },
      xaxis: {
        type: 'datetime',
        datetimeFormatter: {
    ...
    var url = 'https://raw.githubusercontent.com/pcm-dpc/COVID-19/master/dati-json/dpc-covid19-ita-province.json';
    ...
    $.getJSON(url, function(response) {
      ...
      var outputtmp = response.filter(s => s.sigla_provincia === '<?php echo htmlspecialchars($_GET["prov"]); ?>');
      ...
      chart1.updateSeries([{
        name: '<?php echo htmlspecialchars($_GET["provincia"]); ?>',
        data: output,
